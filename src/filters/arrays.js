...
var DiffFilter = function ArraysDiffFilter(context){
    ...
    trimmed1 = array1.slice(commonHead, len1 - commonTail);
    trimmed2 = array2.slice(commonHead, len2 - commonTail);
    var seq = lcs.get(
        trimmed1, trimmed2,
        match,
        matchContext
    ...
    var detectArrayMove = true;
    var includeValueOnArrayMove = false;
